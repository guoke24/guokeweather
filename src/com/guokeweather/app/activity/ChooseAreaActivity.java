package com.guokeweather.app.activity;
...
import com.guokeweather.app.util.HttpCallbackListener;
...
public class ChooseAreaActivity extends Activity {
	...
	private GuokeWeatherDB guokeWeatherDB;
	...
	private void queryProvinces() {
		provinceList = guokeWeatherDB.loadProvinces();
	...
	private void queryCities() {
		...
		if (cityList.size() > 0) {
			...
			adapter.notifyDataSetChanged();
			listView.setSelection(0);
			titleText.setText(selectedProvince.getProvinceName()+","+titleText.getText());
	...
	private void queryCounties() {
		...
		if (countyList.size() > 0) {
			...
			adapter.notifyDataSetChanged();
			listView.setSelection(0);
			titleText.setText(selectedCity.getCityName()+","+titleText.getText());
		...
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
			...
			public void onFinish(String response) {
				...
				if ("province".equals(type)) {
					result = Utility.handleProvincesResponse(guokeWeatherDB,
							response);
				} else if ("city".equals(type)) {
					result = Utility.handleCitiesResponse(guokeWeatherDB,
							response, selectedProvince.getId());
				} else if ("county".equals(type)) {
					result = Utility.handleCountiesResponse(guokeWeatherDB,
